...
class ExploreContainer extends React.Component {
  ...
  componentDidMount(): void {
    ...
    setTimeout(() => {
      const promoPopup: any = document.getElementsByClassName('promo')[0];
      const promoPopupClose: any = document.getElementsByClassName('promo-close')[0];
      ...
      promoPopupClose.addEventListener('click', (e: any) => {
        promoPopup.style.display = 'none';
      });

      const appleLink: any = document.getElementById('apple_link');
      appleLink.addEventListener('click', (e: any) => {
        // ga('send', 'event', 'link promo', 'app');
        window.open('https://apps.apple.com/us/app/fluid-simulation/id1443124993');
      });

      const googleLink: any = document.getElementById('google_link');
      googleLink.addEventListener('click', (e: any) => {
        // ga('send', 'event', 'link promo', 'app');
      ...
      function captureScreenshot() {
        ...
        let texture: any = framebufferToTexture(target);
      ...
      function framebufferToTexture(target: any) {
      ...
      function normalizeTexture(texture: any, width: any, height: any) {
      ...
      function clamp01(input: any) {
        return Math.min(Math.max(input, 0), 1);
      }

      function textureToCanvas(texture: any, width: any, height: any) {
        let captureCanvas = document.createElement('canvas');
        let ctx: any = captureCanvas.getContext('2d');
      ...
      function downloadURI(filename: any, uri: any) {
...
`);
      ...
      const displayMaterial: any = new Material(baseVertexShader, displayShaderSource);
      ...
      function createTextureAsync(url: any) {
        let texture = gl.createTexture();
        gl.bindTexture(gl.TEXTURE_2D, texture);
      ...
      function blur(target: any, temp: any, iterations: any) {
        blurProgram.bind();
            ...
            <div className="promo-content">
              ...
              <div className="promo-body">
                ...
                <div className="links-container">
                  <a className="link" id="apple_link" target="_blank">
                    <img className="link-img" alt="Download on the App Store" src={appBadge} />
                  </a>
                  <a className="link" id="google_link" target="_blank">
                    <img className="link-img" alt="Get it on Google Play" src={gpBadge} />
                  </a>
                </div>
              </div>
            </div>
